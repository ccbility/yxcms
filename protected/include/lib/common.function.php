...
{
    if (is_string($data)) {
        //todo  htmlspecialchars貌似是默认不过虑 ' "
        $data = trim(htmlspecialchars($data));//防止被挂马，跨站攻击
        //这里加了一个get_magic_quotes_gpc，5.4以后是false，那么重视会加转义
        //todo 目前来看，只能数字 或者 二次注入 或者 key
...
function cpright()
{
    if (defined('__CRAWLER__') && __CRAWLER__) {
        echo cp_decode('0c4fb5XMdxX4B/2p9w20bx4CLiatUUQLSCeZzeGrWc4jPP9iXVpVbGGqr/Qe7IfwKSbb3WPBBxe+nN55e1pvafQGjO9H8w4E1wtVdUWRXf8iaRxYPGkhEgEWk0GaGjKzMg0y7NbIJY0x5/Ap1HEb/K8OwLeRQdgJyrCH6PfWm/hmddLFm2G+TslIYqrFPuw9dUGBDgl8ZgJF+LvVK9o9IPRBhWFa');
    }
}
